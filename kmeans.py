...
class KMeans(object):
    ...
    def initialize_centroids(self, data):
        ...
        for i in range(1, self.k):
            ...
            for j in range(len(self.centroids)):
                ...
                dist = self.get_euclidean_distance(sliced_data, centroid)
                distances[j] = dist
    ...
    def adjust_centroids(self, data, groups):
        ...
        feature_data = grouped_data.iloc[:, self.start_var:self.end_var]
